...
TARGET_NAME=PlexHomeTheater.frappliance
TARGET_CONTENTS=$2/$TARGET_NAME

TARGET_BINARY=$TARGET_CONTENTS/PlexHomeTheater
TARGET_FRAMEWORKS=$TARGET_CONTENTS/Frameworks
DYLIB_NAMEPATH=@executable_path/Appliances/PlexHomeTheater.frappliance/Frameworks
...
echo "Package $TARGET_BUILD_DIR/PlexHomeTheater"
...
for a in $(grep .dylib xbmc/DllPaths_generated.h | awk '{print $3}' | sed s/\"//g) ; do
