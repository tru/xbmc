...
if(NOT XCODE_SELECT MATCHES "-NOTFOUND")
  ...
  set(IPHONEOS_SDK_VERSION ${_IPHONEOS_SDK_VERSION} CACHE STRING "Version of IPHONEOS SDK")
  set(IPHONEOS_SDK_PATH ${XCODE_PATH}/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS${IPHONEOS_SDK_VERSION}.sdk)
else()
